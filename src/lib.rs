...
pub enum IrcError {
    ...
    #[doc(alias = "ERR_ERRONEUSNICKNAME")]
    ErroneousNickname(Vec<u32>),
    ...
    /// in use.
    #[doc(alias = "ERR_NICKNAMEINUSE")]
    NicknameInUse(Vec<u32>),
    ...
    #[doc(alias = "ERR_ALREADYREGISTRED")]
    NicknameCollision(Vec<u32>),

    /// A general purpose error returned when a command doesn't have enough paramaters
    #[doc(alias = "ERR_NEEDMOREPARAMS")]
    NeedMoreParamaters,
